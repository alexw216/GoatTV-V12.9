...
.method public readLine(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    invoke-virtual {v6}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->isEmpty()Z
    ...
    .line 257
    invoke-direct {p0, p1, v0}, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->lineFromReadBuffer(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    iget v8, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I

    invoke-virtual {v6, v7, v8, v1}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->append([BII)V
    ...
    :cond_3
    :goto_1
    iget-object v6, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->constraints:Lcz/msebera/android/httpclient/config/MessageConstraints;
    ...
    .line 277
    new-instance v5, Lcz/msebera/android/httpclient/MessageConstraintException;

    const-string v6, "Maximum line length limit exceeded"

    invoke-direct {v5, v6}, Lcz/msebera/android/httpclient/MessageConstraintException;-><init>(Ljava/lang/String;)V
