...
.method buildEntity()Lcz/msebera/android/httpclient/entity/mime/MultipartFormEntity;
    ...
    .prologue
    .line 183
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/MultipartEntityBuilder;->subType:Ljava/lang/String;

    if-eqz v6, :cond_0

    iget-object v5, p0, Lcz/msebera/android/httpclient/entity/mime/MultipartEntityBuilder;->subType:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/MultipartEntityBuilder;->boundary:Ljava/lang/String;
    ...
    .line 188
    .local v1, "bps":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/FormBodyPart;>;"
    :goto_2
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/MultipartEntityBuilder;->mode:Lcz/msebera/android/httpclient/entity/mime/HttpMultipartMode;
    ...
    .line 190
    .local v4, "m":Lcz/msebera/android/httpclient/entity/mime/HttpMultipartMode;
    :goto_3
    ...
    invoke-direct {v3, v5, v2, v0, v1}, Lcz/msebera/android/httpclient/entity/mime/HttpStrictMultipart;-><init>(Ljava/lang/String;Ljava/nio/charset/Charset;Ljava/lang/String;Ljava/util/List;)V

    .line 200
    .local v3, "form":Lcz/msebera/android/httpclient/entity/mime/AbstractMultipartForm;
    :goto_4
    new-instance v6, Lcz/msebera/android/httpclient/entity/mime/MultipartFormEntity;

    invoke-direct {p0, v0, v2}, Lcz/msebera/android/httpclient/entity/mime/MultipartEntityBuilder;->generateContentType(Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-direct {v6, v3, v7, v8, v9}, Lcz/msebera/android/httpclient/entity/mime/MultipartFormEntity;-><init>(Lcz/msebera/android/httpclient/entity/mime/AbstractMultipartForm;Ljava/lang/String;J)V

    return-object v6

    .line 183
    .end local v0    # "b":Ljava/lang/String;
    .end local v1    # "bps":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/FormBodyPart;>;"
    .end local v2    # "cs":Ljava/nio/charset/Charset;
    .end local v3    # "form":Lcz/msebera/android/httpclient/entity/mime/AbstractMultipartForm;
    .end local v4    # "m":Lcz/msebera/android/httpclient/entity/mime/HttpMultipartMode;
    ...
    .line 188
    .restart local v1    # "bps":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/FormBodyPart;>;"
    :cond_3
    ...
    .line 192
    .restart local v4    # "m":Lcz/msebera/android/httpclient/entity/mime/HttpMultipartMode;
    :pswitch_0
    new-instance v3, Lcz/msebera/android/httpclient/entity/mime/HttpBrowserCompatibleMultipart;

    invoke-direct {v3, v5, v2, v0, v1}, Lcz/msebera/android/httpclient/entity/mime/HttpBrowserCompatibleMultipart;-><init>(Ljava/lang/String;Ljava/nio/charset/Charset;Ljava/lang/String;Ljava/util/List;)V

    .line 193
    .restart local v3    # "form":Lcz/msebera/android/httpclient/entity/mime/AbstractMultipartForm;
    goto :goto_4
    ...
    invoke-direct {v3, v5, v2, v0, v1}, Lcz/msebera/android/httpclient/entity/mime/HttpRFC6532Multipart;-><init>(Ljava/lang/String;Ljava/nio/charset/Charset;Ljava/lang/String;Ljava/util/List;)V
